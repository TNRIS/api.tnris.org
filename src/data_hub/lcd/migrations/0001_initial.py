# Generated by Django 2.0.6 on 2018-08-01 13:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AgencyType',
            fields=[
                ('agency_type_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Agency Type ID')),
                ('agency_name', models.TextField(max_length=100, verbose_name='Agency Name')),
                ('agency_abbreviation', models.TextField(blank=True, max_length=100, null=True, verbose_name='Agency Abbreviation')),
                ('agency_website', models.URLField(blank=True, max_length=255, null=True, verbose_name='Agency Website')),
                ('agency_contact', models.TextField(blank=True, max_length=255, null=True, verbose_name='Agency Contact')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acquisition_date', models.TextField(blank=True, max_length=200, null=True, verbose_name='Acquisition Date')),
                ('short_description', models.TextField(blank=True, max_length=400, null=True, verbose_name='Short Description')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('source', models.TextField(blank=True, max_length=255, null=True, verbose_name='Source')),
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('last_modified', models.DateTimeField(auto_now=True, verbose_name='Last Modified')),
                ('agency_type_id', models.ForeignKey(blank=True, db_column='agency_type_id', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='agency_types', to='lcd.AgencyType')),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='agencytype',
            unique_together={('agency_name', 'agency_abbreviation', 'agency_website', 'agency_contact')},
        ),
        migrations.AlterUniqueTogether(
            name='userelate',
        ...
        migrations.AlterUniqueTogether(
            name='resource',
            unique_together={('resource', 'area_type_id', 'collection_id')},
        ),
        migrations.AlterUniqueTogether(
            name='resolutionrelate',
