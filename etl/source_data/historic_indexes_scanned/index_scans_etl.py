...
#
#
# FOR BULK UPDATING photo_index_scanned_ls4_link TABLE IN DATABASE
# CLEARS TABLE, THEN QUERIES FOR ALL HISTORICAL COLLECTIONS AND ASSOCIATES THEIR YEARS USING TEMP VIEW TABLE,
# THEN CRAWLS S3 FOR ALL UPLOADED SCANNED INDEXES, THEN REPOPULATES TABLE WITH ALL SUCCESSFULLY RELATED
# COLLECTIONS AND S3 INDEXES. IGNORES MULTI COUNTY AND PRINTS TERMINAL LIST OF MIS-MATCHED COLLECTION/UPLOADS
#
#
#
