...
class Collection(models.Model):
    ...
    dl_link = models.CharField('Download Link', max_length=250, null=True, blank=True)
...
class Image(models.Model):
    ...
    def __str__(self):
        return self.image_url.replace('https://s3.amazonaws.com/data.tnris.org/', 'https://data.tnris.org/')
