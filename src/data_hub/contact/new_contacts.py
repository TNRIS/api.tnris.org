...
class SubmitFormViewSetSuper(viewsets.ViewSet):
    ...
    permission_classes = [api_helper.CorsPostPermission]
...
class OrderStatusViewSetSuper(viewsets.ViewSet):
    """
...
class InitiateRetentionCleanupViewSetSuper(viewsets.ViewSet):
    """
...
class OrderSubmitViewSetSuper(viewsets.ViewSet):
    permission_classes = [CorsPostPermission]
...
class OrderFormViewSetSuper(viewsets.ViewSet):
    """
