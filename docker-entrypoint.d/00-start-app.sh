...
# export AWS_STORAGE_BUCKET_NAME=`/envs/data-tnris-org/bin/aws ssm get-parameters --name /apps/data_tnris_org/aws_storage_bucket_name --region us-east-1 --output text | awk '{print $6}'`
#
